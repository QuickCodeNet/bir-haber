# 🚀 BirHaber - Generated Microservice Platform
...
- [ ] Open a terminal and run:
  ```bash
  git clone https://github.com/QuickCodeNet/bir-haber.git
  ```
...
- [ ] In a new terminal, run all tests:
  ```bash
  dotnet test QuickCode.BirHaber.Docker.sln
  ```
...
**BirHaber** is a modular, enterprise-grade .NET solution generated by [quickcode.net](https://quickcode.net).  
...
bir-haber/
  src/
    ...
    Modules/
      ...
      IdentityModule/
    Presentation/
      QuickCode.BirHaber.Gateway/
      QuickCode.BirHaber.Portal/
    Services/
    ...
  docker-compose.yml
  README.md
...
- Architecture Diagram:
  ![Architecture Diagram](https://www.quickcode.net/diagram/bir-haber)
...
- **Gateway Dashboard:**
    ...
    - Your project: e.g. [https://bir-haber-gateway.quickcode.net](https://bir-haber-gateway.quickcode.net)
...
- **Portal Dashboard:**
    ...
    - Demo user credentials:
        - Username : demo@quickcode.net
        - Password : String1!
    - Your project: e.g. [https://bir-haber-portal.quickcode.net](https://bir-haber-portal.quickcode.net)
...
- **Gateway:**
    - link: [https://bir-haber-gateway.quickcode.net](https://bir-haber-gateway.quickcode.net)
- **Portal:**
    - link: [https://bir-haber-portal.quickcode.net](https://bir-haber-portal.quickcode.net)
- **Module APIs:**
    - link: [https://bir-haber-identity-module.quickcode.net](https://bir-haber-identity-module.quickcode.net)
    - etc.
...
```json
{
  "Routes": {
    "identity-module": {
      "Match": {
        "Hosts": ["bir-haber-gateway.quickcode.net"],
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://bir-haber-identity-module.quickcode.net"
        }
      }
    }
  }
...
1. Open `src/QuickCode.BirHaber.Docker.sln` in Rider.
...
**Last generation Time**: [Generated on: 2026-07-22 21:38:45 UTC]