...
using QuickCode.BirHaber.Infrastructure.Integration.Helpers;
...
using QuickCode.BirHaber.Portal.Mapper;
using QuickCode.BirHaber.Portal.ViewEngines;
using QuickCode.BirHaber.Infrastructure.Web.Middleware;
using QuickCode.BirHaber.Portal.Middleware;
