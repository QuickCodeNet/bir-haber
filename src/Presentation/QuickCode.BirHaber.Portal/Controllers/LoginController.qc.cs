...
using LoginRequest = QuickCode.BirHaber.Infrastructure.Integration.Nswag.Clients.IdentityModuleApi.Contracts.LoginRequest;


using ForgotPasswordRequest = QuickCode.BirHaber.Infrastructure.Integration.Nswag.Clients.IdentityModuleApi.Contracts.ForgotPasswordRequest;
using ResetPasswordRequest = QuickCode.BirHaber.Infrastructure.Integration.Nswag.Clients.IdentityModuleApi.Contracts.ResetPasswordRequest;

namespace QuickCode.BirHaber.Portal.Controllers
{
